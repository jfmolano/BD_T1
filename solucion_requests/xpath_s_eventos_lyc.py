...
#INICIO SCRIPT - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
url_eventos = 'https://lenguas.uniandes.edu.co/index.php/noticias'
url_artes = 'https://lenguas.uniandes.edu.co'
...
for dia in dias:
	...
	resp['nombre_e'] = ""
	resp['correo_e'] = ""
	resp['dependencia'] = "Departamento de Lenguas y Cultura"
	resp['palabras'] = ""
	data.append(resp)
	print "- - - - - - - - - - - - - - - - - - -"
	print "- - - - - - - - - - - - - - - - - - -"
print data
with open('lyc.json', 'w') as outfile:
