...
#INICIO SCRIPT - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
url_eventos = 'https://antropologia.uniandes.edu.co/index.php/noticias-y-eventos'
url_artes = 'https://antropologia.uniandes.edu.co'
...
for dia in dias:
	...
	resp['nombre_e'] = ""
	resp['correo_e'] = ""
	resp['dependencia'] = "Departamento de Antropologia"
	resp['palabras'] = ""
	data.append(resp)
	print "- - - - - - - - - - - - - - - - - - -"
	print "- - - - - - - - - - - - - - - - - - -"
print data
with open('antropologia.json', 'w') as outfile:
